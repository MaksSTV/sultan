...
function ListItems(props: {
  ...
  return (
    <NavLink to={`/card/${props.barcode}`}>
      <div className='item' key={props.barcode}>
        <img className='item__img' src={props.url} alt="" />
        <div className="item__text">
          <div className="item__size">{props.size}</div>
          <div className="item__title">
            <b>{props.name}</b> {props.name_desc}
          </div>
          <div className="item__info">
            <div className="item__barcode">Штрихкод: <b>{props.barcode}</b></div>
            <div className="item__manufacturer">Производитель: <b>{props.manufacturer}</b></div>
            <div className="item__brand">Бренд: <b>{props.brand}</b></div>
          </div>
