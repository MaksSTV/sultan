                                    ...
                                    <div className="filters__manufacturer-block-input">
                                        ...
                                        <div className="filters__manufacturer-checkbox-lists">
                                            <div className="checkbox">
                                                <label className='checkboxText'>Paclan</label>
                                                <input type="checkbox" />
                                            </div>
                                            <div className="checkbox">
                                                <label className='checkboxText'>Boyscout</label>
                                                <input type="checkbox" />
                                            </div>
                                            <div className="checkbox">
                                                <label className='checkboxText'>Булгари Грин</label>
                                                <input type="checkbox" />
                                            </div>
                                            <div className="checkbox">
                                                <label className='checkboxText'>Grifon</label>
                                                <input type="checkbox" />
                                            </div>
                                            <div className="checkbox">
                                                <label className='checkboxText'>Nivea</label>
                                                <input type="checkbox" />
                                            </div>
                                        ...
                                        <div className="filters__manufacturer-submit">
                                            <button className='filters__manufacturer-button'>Показать</button>
                                            <input type="reset" value="" className='filters__manufacturer-reset'></input>
                                        </div>
                                    </div>
